...
public class RabbitEnemy : StatefulObjectBase<RabbitEnemy, EnemyState>
{
    private int life;
...
//    private float speed = 0.1f;
    ...
    public void Initialize()
    {
        ...
        stateMachine = new StateMachine<RabbitEnemy>();
    ...
    public void TakeDamage()
    {
        if (life <= 0)
        {
            ChangeState(EnemyState.Destroy);
        }
    }
    ...
    #region States
    //StateWait
    private class StateWait : State<RabbitEnemy>
    {
        public StateWait(RabbitEnemy owner) : base(owner) { }
    ...
    //StateWander
    private class StateWander : State<RabbitEnemy>
    {
        private Vector3 distance;
        public StateWander(RabbitEnemy owner) : base(owner) { }
        public override void Enter()
        {
    ...
    //StatePursuit
    private class StatePursuit : State<RabbitEnemy>
    {
        private int buf;
        public StatePursuit(RabbitEnemy owner) : base(owner) { }
        public override void Enter()
        {
            owner.animator.speed = 1f;
        }
    ...
    //StateDestroy
    private class StateDestroy : State<RabbitEnemy>
    {
        public StateDestroy(RabbitEnemy owner) : base(owner) { }
        public override void Enter()
        {
            Destroy(owner);
        }
    ...
    //StateAttack
    private class StateAttack : State<RabbitEnemy>
    {
        public StateAttack(RabbitEnemy owner) : base(owner) { }
        public override void Enter()
        {
